 ...
 */
public class UploadArticlePhoto {
...
//			.getProperty("user.dir") + "/sample.jpeg";
	...
	public String upload(String username,String filename,File file) throws IOException{
		// 初始化空间
		upyun = new UpYun(BUCKET_NAME, OPERATOR_NAME, OPERATOR_PWD);		
		upyun.setDebug(false);
		DIR_ROOT = "/myblog/user/"+username+"/articlephotos/"+filename;
		// 1.上传文件（文件内容）
		return testWriteFile(file);
	}
	 ...
	 * @throws IOException
	 */
	public static String testWriteFile(File file) throws IOException {
