...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>${hostuser.name }的博客-${artCatNowVis.cat_name}</title>
...
<div style="margin: 0 auto;min-height:500px;width: 960px;">
	...
	<ul class="pagination">
		...
		<c:forEach var="i" begin="1" end="${totalpage}">	
			<li><a href="${pageContext.request.contextPath}/visitor/${loginuser.name}/articlecatlog/${artCatNowVis.art_cat_id}/${i}">${i }</a></li>
		</c:forEach>
