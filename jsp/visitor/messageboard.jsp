...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>${hostuser.name }的博客-留言板</title>
...
<!-- 评论区 -->
	...
	<div style="margin:0 auto; width: 960px;">
		...
		<div>
			...
			<span style="color: blue">${message.comment_writer.name }&nbsp;&nbsp;${message.formatdate}</span><br>
...
<script type="text/javascript">
	   ...
	   function submitmessage(){
		...
		temp.action = "${pageContext.request.contextPath}/visitor/${loginuser.name}/submitmessage";
		temp.method = "post";
		...
		commentreceiver.value = ${hostuser.user_id};
