...
<ul class="nav nav-pills nav-stacked">
    ...
    <c:forEach items="${artCatList}" var="artCat">
		<li style="text-align: center;">
			<a href="${pageContext.request.contextPath}/user/${loginuser.name}/articlecatlog/${artCat.art_cat_id}/1">${artCat.cat_name }</a>
		</li>
	</c:forEach>
...
<div style="margin: 0 auto;width: 960px;min-height: 500px;">
	...
	<ul class="pagination">
		...
		<c:forEach var="i" begin="1" end="${totalpage}">	
			<li><a href="${pageContext.request.contextPath}/user/${loginuser.name}/articlelist/${i}">${i }</a></li>
		</c:forEach>
