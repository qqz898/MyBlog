  ...
  <div class="pull-right">
	...
	<form role="form">
		<div class="form-group">
			...
			<input type="text" id="blogtitle" class="form-control" placeholder="请输入标题"/><br/>
		</div>
 	</form>
    ...
    <div style="text-align:left;">
        <div id="divDemo" style="height:700px;"></div>
    </div><!--demo end-->
...
<div id="copyright">
    ...
    <script type="text/javascript">
		...
		function submitblog(){
	    		...
	    		temp.action = "${pageContext.request.contextPath}/user/${loginuser.name}/submitblog";
	    		temp.method = "post";
