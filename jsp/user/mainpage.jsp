	...
	<div class="zerogrid">
		<div class="row block">
			<div class="main-content col11">
				...
				<c:forEach items="${recentfourblog}" var="mainpageblog">
					<article>
						<div class="heading">
							<h2><a href="${pageContext.request.contextPath}/user/${loginuser.name}/articlelist/read/${mainpageblog.blog_id}">${mainpageblog.title }</a></h2>
							<p class="info">>>> Posted by ${loginuser.name } - ${mainpageblog.time } - &nbsp;${mainpageblog.comment_num } Comments</p>
						</div>
						<div class="content">
						...
						<div class="footer">
							<p class="more"><a class="button" href="${pageContext.request.contextPath}/user/${loginuser.name}/articlelist/read/${mainpageblog.blog_id}">Read more >></a></p>
						</div>
					</article>
					<hr>
				</c:forEach>											
			...
			<div class="sidebar col05">
				<section>
					...
					<div class="content">
							...
							<strong>用户ID：</strong>&nbsp;&nbsp;&nbsp;${loginuser.name } <br>
							<strong>昵&nbsp;&nbsp;称：</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${loginuser.nickname }<br>
							<strong>Email：</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${loginuser.email }<br>
							<strong>个人简介：</strong>${loginuser.introduction }
							</span>
				...
				<section>
					...
					<div class="content">
						<ul class="list">
							<c:forEach items="${recentfourblog}" var="mainpageblog">
								<li><a href="${pageContext.request.contextPath}/user/${loginuser.name}/articlelist/read/${mainpageblog.blog_id}">${mainpageblog.title }</a></li>
							</c:forEach>
				...
				<section>
					...
					<div class="content">
						<c:forEach items="${mainPageAlbum}" var="mainpagealbum">							
							...
							<section>
								...
								<h4><a href="${pageContext.request.contextPath}/user/${loginuser.name}/album/${mainpagealbum.album_id}">${mainpagealbum.album_name }</a></h4>
...
<div id="copyright">
	<p style="">京ICP备17020361号　｜　Copyright © 2016 - Daniel Qiu<br>
